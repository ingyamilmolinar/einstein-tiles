...
const H1_hat = new Geom( hat_outline, [4, 102, 46], [255, 255, 255] );
//const H_hat = new Geom( hat_outline, [148, 205, 235], [0, 0, 0] );
const H_hat = new Geom( hat_outline, [44,137,179], [255, 255, 255] );
//const T_hat = new Geom( hat_outline, [251, 251, 251], [0, 0, 0] );
const T_hat = new Geom( hat_outline, [232, 208, 25], [255, 255, 255] );
//const P_hat = new Geom( hat_outline, [250, 250, 250], [0, 0, 0] );
const P_hat = new Geom( hat_outline, [222,40,45], [255, 255, 255] );
//const F_hat = new Geom( hat_outline, [191, 191, 191], [0, 0, 0] );
const F_hat = new Geom( hat_outline, [51,29,89], [255, 255, 255] );
...
function setup() {
	...
	reset_button.mousePressed( function() {
		...
		setButtonActive( draw_super, false );
		loop();
	} );
